...
- [ ] Open `WORKSHOP.md`, current `exercises/solutions/exercise-N-NAME-steps.md`, and `steps/`.
...
- Space 2: `WORKSHOP.md`, current `exercises/solutions/exercise-N-NAME-steps.md`, and code.
